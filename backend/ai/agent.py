...
class DarukaaAgent:
    """Agentic AI engine with tool execution transparency."""
    ...
    def process_query(self, query: str) -> AgentQueryResponse:
        ...
        if "largest improvement in biodiversity" in query_lower or "biodiversity" in query_lower:
            ...
            if best_site and best_trend:
                ...
                answer = "Based on demonstration dataset, no significant biodiversity improvement was recorded."
            ...
            if top:
                ...
                answer = "No active projects were found in the database."
            ...
            if len(sites) >= 2:
                ...
                answer = "Insufficient sites in database to perform comparison."
